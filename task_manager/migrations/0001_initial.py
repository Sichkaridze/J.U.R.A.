# Generated by Django 5.1.5 on 2025-02-02 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.IntegerField(choices=[(0, 'Intern'), (1, 'Junior'), (2, 'Middle'), (3, 'Senior'), (4, 'Lead')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(default='Dismissed employee', on_delete=django.db.models.deletion.SET_DEFAULT, related_name='created_tasks', to=settings.AUTH_USER_MODEL)),
